use contra_withdraw_program_client::CONTRA_WITHDRAW_PROGRAM_ID;
use {
...
pub async fn run_precompile_accounts_test(contra_ctx: &ContraContext) {
    ...
    let precompiles = vec![
        ...
        TestPrecompile {
            pubkey: CONTRA_WITHDRAW_PROGRAM_ID,
    ...
    for precompile in precompiles {
        ...
        // Get account info
        let account = contra_ctx.read_client.get_account(&precompile.pubkey).await;
