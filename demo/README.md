...
- `VITE_WRITE_URL`: URL for write operations (default: https://write.example.com — placeholder, replace with your real endpoint before use)
- `VITE_READ_URL`: URL for read operations (default: https://read.example.com — placeholder, replace with your real endpoint before use)
