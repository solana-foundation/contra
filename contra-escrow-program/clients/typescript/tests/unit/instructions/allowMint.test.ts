...
describe('allowMint', () => {
    ...
    describe('Account requirements', () => {
        it('should include all required accounts: payer, admin, instance, mint, allowedMint, instanceAta, systemProgram, tokenProgram, associatedTokenProgram, eventAuthority, contraEscrowProgram', async () => {
            const payer = mockTransactionSigner(TEST_ADDRESSES.PAYER);
            const admin = mockTransactionSigner(TEST_ADDRESSES.ADMIN);
            const instance = TEST_ADDRESSES.INSTANCE;
            const mint = TEST_ADDRESSES.WRAPPED_SOL;
            ...
            // Account 10: contraEscrowProgram (Readonly)
            const contraEscrowProgramAccount = instruction.accounts[10];
        ...
        it('should set correct account permissions (writable/readable/signer)', async () => {
            ...
            // Account 10: contraEscrowProgram - should be Readonly
            const contraEscrowProgramAccount = instruction.accounts[10];
