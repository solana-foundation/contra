...
use {
    ...
    test_utils::{mock_rpc::Reply, operator_helper::start_solana_to_private_channel_operator_with_mocks},
};
...
async fn operator_mock_harness_drives_deposit_through_to_send_transaction() {
    ...
    let harness = start_solana_to_private_channel_operator_with_mocks(escrow_instance_id, operator_keypair)
        .await
